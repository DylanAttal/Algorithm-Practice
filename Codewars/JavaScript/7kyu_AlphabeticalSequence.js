/* In this kata you will be given a random string of letters and tasked with returning them as a
string of comma-separated sequences sorted alphabetcally, with each sequence starting with an uppercase
...
function alphaSeq (str) {
  ...
  return str.toLowerCase().split('').map(letter => letter.toUpperCase() + letter.repeat(alphabet.indexOf(letter))).sort().join(',')
}
