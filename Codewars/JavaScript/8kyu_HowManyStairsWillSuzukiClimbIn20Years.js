/* Suzuki is a monk who climbs a large staircase to the monastery as part of a ritual. Some days he climbs more
stairs than others depending on the number of students he must train in the morning. He is curious how many stairs 
might be climbed over the next 20 years and has spent a year marking down his daily progress.
...
function stairsIn20(s){
  return s.map(array => array.reduce((acc, val) => acc + val)).reduce((acc, val) => acc + val) * 20;
}
